...
public class CombineChr2L2R3L3RandX {
	...
	public static void main(String[] args) throws IOException{
		...
		//1st, create Scanners;
		Scanner read_2L = new Scanner(new File("D:/2014FallRotation/data/BED_DM433_2L_output_t_922.txt"));
		Scanner read_2R = new Scanner(new File("D:/2014FallRotation/data/BED_DM433_2R_output_t_922.txt"));
		Scanner read_3L = new Scanner(new File("D:/2014FallRotation/data/BED_DM433_3L_output_t_922.txt"));
		Scanner read_3R = new Scanner(new File("D:/2014FallRotation/data/BED_DM433_3R_output_t_922.txt"));
		Scanner read_X = new Scanner(new File("D:/2014FallRotation/data/BED_DM433_X_output_t_922.txt"));
		
		
		//2nd, create an writter; 
		File output_file = new File("D:/2014FallRotation/data/BED_DM433_allChrs_output_924.txt");
