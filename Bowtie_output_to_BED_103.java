 ...
 *
 */
public class Bowtie_output_to_BED_103 {
	...
	public static void main(String[] args) throws IOException{
		...
		*************************************************************************************************************/
		...
		Scanner BowtieReader = new Scanner(new File("D:/2014FallRotation/data/yulong/"+ document +"_bowtie_output.txt"));
		
		
		String Fstline = BowtieReader.nextLine();
		System.out.println("1: " + Fstline);
		
		File output_file = new File("D:/2014FallRotation/data/yulong/" + document +"_bowtie2BED_" + chromosome + "_101.txt");
